...
(function() {
  var KeyManager, Networking, PVMSettings, Syslog, cloudCredentials,
  ...
  ko.components.register('syslog', {
    viewModel: Syslog = (function() {
      function Syslog(params) {
        ...
        this.newIp1 = ko.observable('');
        this.newPort1 = ko.observable('');
        this.newIp2 = ko.observable('');
        this.newPort2 = ko.observable('');
        this.updateSyslog = ko.computed(function() {
          return _this.syslog({
            ip1: _this.ip1,
            ip2: _this.ip2,
            port1: _this.port1,
