...
(function() {
  var Clouds, Groups, Instances, Regions,
  ...
  ko.components.register('clouds', {
    viewModel: Clouds = (function() {
      function Clouds() {
        ...
        this.groupsIndex = ko.observableArray();
        this.init();
      }
  ...
  ko.components.register('groups', {
    viewModel: Groups = (function() {
      function Groups(params) {
        ...
        this.groups = {};
        this.groupsIndex = this.params.groupsIndex;
        this.init();
      }
      ...
      Groups.prototype.getGroups = function() {
        ...
        loadList = function(r) {
          _this.groups = r;
          return _this.groupsIndex(Object.keys(_this.groups));
        };
