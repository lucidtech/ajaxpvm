...
ko.components.register 'users',
    ...
    class PVMUsers
      ...
      constructor: () ->
        ...
        @sortedRoles = ko.computed =>
          @allRoles().sort()
        @sortedGroups = ko.observable().subscribeTo('groups/groupsIndex')
        @init()
  ...
  template:
    require : "/static/requirejs/text.js!views?template=users/users"
...
ko.components.register 'user',
  ...
  template:
    require : "/static/requirejs/text.js!views?template=users/user"
