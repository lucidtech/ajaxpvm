  ...
  ko.components.register('instances', {
    viewModel: Instances = (function() {
      ...
      function Instances(params) {
        ...
        this.groupsIndex = ko.observable(new Array()).subscribeTo('groups/groupsIndex');
        this.groupsInstancesIndex = ko.observable(new Object());
        this.updateGroupsInstancesIndex = ko.computed(function() {
          return _this.groupsIndex().forEach(function(group, index, array) {
            if (typeof _this.groupsInstancesIndex()[group] === 'undefined') {
              return pvm.methods.getInstanceGroup.call(group, function(list) {
                return _this.groupsInstancesIndex()[group] = list;
              });
            }
          });
        });
